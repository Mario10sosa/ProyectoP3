...
namespace Presentacion
{
    public partial class FrmAgregarCliente : Form
    {
        ...
        ServicioContactoClientes servicioCliente = new ServicioContactoClientes();
        CE_Clientes Cliente = new CE_Clientes();

        public delegate void UpdateDelegate(object sender, UpdateEventArgs args);
        public event UpdateDelegate UpdateEventHandler;

        public FrmAgregarCliente(FrmClientes Clientes, FrmAgregarVenta venta, FrmAgregarAlquiler alquiler)
        {
            InitializeComponent();
            Restrinccion();
        }
        ...
        {
            TxtCodigoCliente.Text = Procedimientos.GenerarCodigoId("Clientes");
        }
        ...
        private bool Guardar()
        {
            try
            {
                ...
                {
                    MostrarMensaje("Por Favor Debe completar todos los campos", "Agregar Clientes", MessageBoxIcon.Exclamation);
                }
                else
                {
                    ...
                    MostrarMensaje("El Cliente fue agregado correctamente", "Agregar Cliente", MessageBoxIcon.Information);
                    LimpiarFormulario();
                    GenerarId();
            ...
            {
                MostrarMensaje("El Cliente no fue agregado por: " + ex.Message, "Agregar Cliente", MessageBoxIcon.Error);
            }
            return false;
        }
        ...
        {
            return string.IsNullOrWhiteSpace(TxtCodigoCliente.Text) ||
        ...
        {
            if ((textBox == TxtCodigoCliente || textBox == TxtCedulaCliente) &&
