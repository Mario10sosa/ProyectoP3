...
namespace Presentacion
{
    public partial class FrmEditarProducto : Form
    {
        ...
        public FrmEditarProducto(FrmProductos prductoss)
        {
            InitializeComponent();
            Restrinccion();
        }
        ...
        public void EditarProducto()
        {
            try
            {
                ...
                {
                    MostrarMensaje("Por Favor Debe completar todos los campos", "Editar Producto", MessageBoxIcon.Exclamation);
                }
                else
                {
                    ActualizarDatosProducto();
                    productos.EditarProducto(producto);
                    MostrarMensaje("El Producto fue Editado correctamente", "Editar Producto", MessageBoxIcon.Information);
            ...
            {
                MostrarMensaje("El Producto No Fue Editado Por: " + ex.Message, "Editar Producto", MessageBoxIcon.Error);
            }
        }
